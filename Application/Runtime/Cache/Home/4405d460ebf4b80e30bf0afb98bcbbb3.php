...
<div class='container-fluid'>
	...
	<div id="op_area" class="row-fluid" style="border: none;font-weight: bold;">
		...
		<div class="span2 box-quick-link green-background">
			...
			<a href="/POS/index.php/home/download/showDetail">
	...
	<div class="row-fluid">
		<table id="table" class="datatable" data-striped="true" data-toggle="table" data-url="/POS/index.php/home/download/getList" data-show-columns="true" data-search="true" data-show-refresh="true" data-show-toggle="true" data-pagination="true" data-show-export="true">
			<thead>
				<tr>
...
<script>
	...
	function btnDownload(index) {
		...
		console.log(row);
		window.open("/POS/Uploads/" + row['file_url']);
	};
	...
	function btnConfirmedRemove() {
		...
		console.log(row);
		window.location = "/POS/index.php/home/download/delete?fileNum=" + row['file_num'];
	};
</script>
	</body>

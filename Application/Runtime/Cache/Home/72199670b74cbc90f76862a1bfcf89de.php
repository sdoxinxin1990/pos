...
<div class='container-fluid'>
	...
	<div class='row-fluid' id='content-wrapper'>
		...
		<div class='span12'>
			...
			<div class='page-header'>
				...
				<h1 class='pull-left'><i class='icon-inbox'></i>&nbsp;&nbsp;<span>SIM管理</span></h1>
	...
	<div id="op_area" class="row-fluid" style="border: none;font-weight: bold;">
		...
		<div class="span2 box-quick-link green-background">
			...
			<a href="/POS/index.php/home/s_i_m/import">
	...
	<div class="row-fluid">
		<table id="table" class="datatable" data-striped="true" data-toggle="table" data-url="/POS/index.php/home/s_i_m/getList" data-show-columns="true" data-search="true" data-show-refresh="true" data-show-toggle="true" data-pagination="true" data-show-export="true">
			<thead>
				<tr>
					<th data-field="sim_id">SIMID</th>
					<th data-field="sim_serial_number">序列号</th>
					<th data-field="sim_brand">品牌</th>
					<th data-field="sim_type">型号</th>
					<th data-field="binding_state">绑定状态</th>
					<th data-field="binding_time">绑定时间</th>
					<th data-field="sim_create_time">创建时间</th>
...
<script>
	...
	function btnConfirmedRemove() {
		...
		console.log(row);
		window.location = "/POS/index.php/home/s_i_m/delete?simID=" + row['sim_id'];
	};
</script>
	</body>

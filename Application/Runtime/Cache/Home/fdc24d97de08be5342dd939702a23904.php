...
<div class='container-fluid'>
	...
	<div class="row-fluid" style="border: none;font-weight: bold;">
		...
		<div class="span2 box-quick-link green-background">
			...
			<a href="/POS/index.php/home/member/showDetail?op=add">
	...
	<div class="row-fluid">
		<table id="table" class="datatable" data-striped="true" data-toggle="table" data-url="/POS/index.php/home/member/getList" data-show-columns="true" data-search="true" data-show-refresh="true" data-show-toggle="true" data-pagination="true" data-show-export="true">
			<thead>
				<tr>
...
<script>
	...
	function btnShowDetail(index) {
		...
		console.log(row);
		window.location = "/POS/index.php/home/member/showDetail?op=edit&member_uuid=" + row['member_uuid'];
	};

	function btnDisable(index) {
		var row = $("#table").bootstrapTable('getData')[index];
		console.log(row);
		window.location = "/POS/index.php/home/member/disable?member_uuid=" + row['member_uuid'];
	};

	function btnEnable(index) {
		var row = $("#table").bootstrapTable('getData')[index];
		console.log(row);
		window.location = "/POS/index.php/home/member/enable?member_uuid=" + row['member_uuid'];
	};
	...
	function btnConfirmedRemove() {
		...
		console.log(row);
		window.location = "/POS/index.php/home/member/delete?member_uuid=" + row['member_uuid'];
	};
</script>
	</body>

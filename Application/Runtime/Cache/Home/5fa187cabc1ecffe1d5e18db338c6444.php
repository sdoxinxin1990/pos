...
<div class='container-fluid'>
	...
	<form id="mform" action="/POS/index.php/home/s_i_m/saveImport" method="post" class='form validate-form' enctype="multipart/form-data">
		<div class='row-fluid'>
			<div class='span12'>
				&nbsp;&nbsp;<i class='icon-upload'></i>&nbsp;&nbsp;SIM卡激活
			</div>
		</div>
		...
		<div class='row-fluid'>
			...
			<div class='span10'>
				...
				<a href="/POS/Downloads/SimCardActivate.csv" class="text-error">&nbsp;&nbsp;&nbsp;&nbsp;下载模版&nbsp;&nbsp;&nbsp;&nbsp;</a>
			</div>
		</div>
